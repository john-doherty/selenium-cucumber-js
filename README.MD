...
Shared objects are the place to load any objects that need to be shared throughout the project but are not considered page objects, this could be a test variables or helper methods.
